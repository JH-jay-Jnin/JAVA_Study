...
public class GenerateStream {
    public static void main(String[] args) throws IOException {
        ...
        // Arrays.asList() : list를 만드는데 배열처럼 값을 넣어서 (*크기가 고정된*) List를 빠르게 만드는 방법
        //                    ==> 조회용도로 빠르게 테스트할 때 사용
        // 즉, Collection은 추가 삭제가 자유롭지만, asList는 고정된 값이라서 수정 삭제가 불가능하다.
        ...
        // -> 값을 바로 넣어서 스트림 생성할 수 있게 해준다.
        Stream<String> stream3 = Stream.of("a", "b", "c");

        // 4. 빈 스트림 생성
        Stream<String> emptyStream = Stream.empty(); // 빈 배열처럼 생각!

//==========================================================================================//

        // 5. Stream.builder() 사용 - Builder 패턴
        // -> 값을 하나씩 모아서 스트림을 만드는 방법 (단계적으로)
