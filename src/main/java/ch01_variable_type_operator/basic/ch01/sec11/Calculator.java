...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        int x = 1; // 변수 x를 선언하고 1을 대입해라
        int y = 2; // (정수형)변수 y를 int로 선언하고 2를 대입해라
        int result = x + y; // 변수 result를 int로 선언하고 x + y를 대입해라
        // result 값 출력하기
        System.out.println(result);
        // Java에서는 ""를 쓰면 변수 안에 값이 아니라 result라는 변수명이 출력된다.
        // System.out.println("result"); <= 이 주석 풀어서 확인해보기
    }
