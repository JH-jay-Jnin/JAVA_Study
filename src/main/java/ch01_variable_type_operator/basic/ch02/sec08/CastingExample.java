...
public class CastingExample {
    ...
    public static void main(String[] args) {
        /* 형변환(Casting)
         * 자료형을 다른 자료형으로 변경해주는 것(단, boolean을 제외한 기본 자료형 끼리!)
         *
         * 형변환이 필요한 이유
        ...
        // 강제 형변환
        int var1 = 10;
        byte var2 = (byte)var1; // 같은 연산자로 맞춰줘야 오류가 안난다!
...
//        System.out.println(var8);
        ...
        // 자동 형변환
        double var9 = 3.1415926789;
        int var10 = 12345;
        System.out.println(var9 + var10);
        //              double + int
        //              double + double(12345.0) = double 으로 바꾸는 자동 형변환이다.
